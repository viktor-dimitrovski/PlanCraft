...
{
    /// <inheritdoc />
    public partial class Add_Phase1_5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    CapacityHoursPerWeek = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioOverrides", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptimisticDays = table.Column<int>(type: "integer", nullable: true),
                    MostLikelyDays = table.Column<int>(type: "integer", nullable: true),
                    PessimisticDays = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
